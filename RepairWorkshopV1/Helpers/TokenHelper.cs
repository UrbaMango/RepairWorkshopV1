...
namespace RepairWorkshopV1.Helpers
{
    public class TokenHelper
    {
        public const string Issuer = "http://bakalauras.com";
        public const string Audience = "http://baklauras.com";
        ...
        public static string GenerateTokenClient(Users user)
        {
            var tokenHandler = new JwtSecurityTokenHandler();
            var key = Convert.FromBase64String(Secret);
